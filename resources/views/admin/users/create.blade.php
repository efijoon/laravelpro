...
@section('content')
    <x-admin.content-header title="ایجاد کاربر جدید">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <form action="/admin/users" class="form-horizontal" method="post">
                    @csrf
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="form-group col-sm-3">
                                ...
                                <input name="email" type="email" class="form-control" placeholder="ایمیل را وارد کنید" value="{{ old('email') }}">
                            </div>
